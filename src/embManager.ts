...
async function findTheRelatedSentences(content: string): Promise<string[]> {
  ...
  contextMaxTokens = Number(contextMaxTokens.toString());
...
async function findRelatedConversations(
  maxTokens: number,
  contentEmb: number[],
  conversations: any[][],
): Promise<any[]> {
...
export async function init(
  modelArgs: ModelArgs,
  contextEmbArgs: ContextEmbArgs,
  conversationsEmbArgs: ConversationsEmbArgs,
) {
