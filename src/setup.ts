...
export async function setUp(apiKey: string, precentForContext: number, precentForConversations: number, promptOutputTokens: number, sentenceSplitorOfContext: string, completationModelMaxTokens: number, useContextOnlyTheSimilarityGoeTo: number, completationModelName: string) {
